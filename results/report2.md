...
解析雨量を用いて、2006～2025年の年最大24時間降水量から格子ごとにGEV分布を推定し、令和8年8月千葉豪雨の再現期間を計算した。降水量が最大となった千葉市内の格子（560.9 mm）の再現期間は144年、市原市内で降水量が最大の格子（553.4 mm）は201年だった。元記事で約1,182年とされた東金・大網白里付近は本解析では50年程度、約277年とされた茂原市付近は49.4年となり、多くの地域で元記事より短い再現期間となった。

再現期間が1万年を超えたのは、市原市北部の1格子（約67万年）のみだった。この値は、過去20年の最大値を大きく上回る雨を、推定されたGEV分布の上限付近で評価したことによるものである。ブートストラップ法による95%区間は70.9年～∞と非常に広く、隣接する8格子の再現期間は66～486年だった。1つの格子の極端な値は推定の不安定さを強く反映しており、これだけを取り出して「1万年を大きく超える」と伝えるのは適切ではないと考えられる。

アメダスを用いた比較では、千葉の再現期間は1976～2014年に基づくと299年、2006～2025年に基づくと119年となり、推定に用いる期間によって2倍以上変わった。一方、同じ2006～2025年に基づけば、アメダス（119年）と解析雨量（112年）の再現期間は近かった。千葉については、前回の記事でアメダスから得た約300年と、今回の解析雨量による約110年の違いの多くは、データの違いではなく期間の違いによるものといえる。元記事の「過去の気候」は1995年を中心とする約39年間であり、本解析より古い期間を基準としているため、再現期間は長めに算出される方向に働くと考えられる。これは元記事との差の一因になり得る。ただし、元記事は気候シミュレーションから分布を推定しているため、データ・期間・手法それぞれの寄与を本解析から切り分けることはできていない。
